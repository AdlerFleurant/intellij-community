...
public final class EqualSizeCellsTest {
  ...
  public void test1() {
    ...
    Assertions.assertEquals(329, field1.getWidth());
    Assertions.assertEquals(329, field2.getWidth());
    Assertions.assertEquals(328, field3.getWidth());
  }
  ...
  public void test2() {
    ...
    panel.add(field1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
                                          ...
                                          GridConstraints.SIZEPOLICY_WANT_GROW | GridConstraints.SIZEPOLICY_CAN_SHRINK, null, null, null,
                                          0));
