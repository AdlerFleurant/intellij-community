...
public final class Layout5Test {
  ...
  public void test1() {
    ...
    panel.add(label, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
                                         GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(0, 0), null,
                                         null, 0));

    panel.add(field1, new GridConstraints(0, 1, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
                                          GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, new Dimension(0, 0), null,
                                          null, 0));
  ...
  public void test2() {
    ...
    Assertions.assertEquals(3, horizontalInfo.getCellCount());
    Assertions.assertEquals(GridConstraints.SIZEPOLICY_CAN_SHRINK, horizontalInfo.getCellSizePolicy(0));
    Assertions.assertEquals(GridConstraints.SIZEPOLICY_WANT_GROW, horizontalInfo.getCellSizePolicy(1));
    Assertions.assertEquals(GridConstraints.SIZEPOLICY_CAN_SHRINK, horizontalInfo.getCellSizePolicy(2));
    ...
    panel.doLayout();
    Assertions.assertEquals(400, field1.getWidth());
    Assertions.assertEquals(400, field2.getWidth());
  }
  ...
  public void test3() {
    ...
    // after getPreferredSize() invocation, the field should be not null 
    final DimensionInfo horizontalInfo = layoutManager.myHorizontalInfo;
    Assertions.assertEquals(GridConstraints.SIZEPOLICY_FIXED, horizontalInfo.getCellSizePolicy(0));
    Assertions
    ...
    Assertions.assertEquals(GridConstraints.SIZEPOLICY_FIXED, horizontalInfo.getCellSizePolicy(2));
    ...
    panel.setSize(400, 100);
    panel.doLayout();
    Assertions.assertEquals(390, field1.getWidth());
    Assertions.assertEquals(390, field2.getWidth());
